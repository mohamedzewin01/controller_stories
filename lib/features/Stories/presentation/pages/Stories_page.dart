...
import '../widgets/story_details_sheet.dart';
import '../widgets/story_form_dialog.dart';
import '../widgets/stories_statistics_card.dart';
import '../widgets/stories_filter_bar.dart';
...
class _StoriesPageState extends State<StoriesPage>
  ...
  void initState() {
    ...
    // Setup animations with proper constraints
    _fabController = AnimationController(
      duration: const Duration(milliseconds: 600),
      vsync: this,
    );
    ...
    // Start animations with delay to prevent issues
